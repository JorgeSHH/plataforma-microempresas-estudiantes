 ...
 <header>
    <nav class="menu">
        ...
        <ul class="menu-navegacion">
            <li><a href="/plataforma-estudiantes-microempresas/index.php">Home</a></li>
            <li><a href="#">Empresas</a></li>
            <li><a href="#">Estudiantes</a></li>
            <li><a href="/plataforma-estudiantes-microempresas/login/login.php">Login</a></li>
        </ul>
    </nav>
</header>
...
<section class="formulario-empresa">
    ...
    <article class="parte1">
        ...
        <div class="containerformulario">
                ...
                <div class="container-inputs">
                    ...
                    <div class="datos-empresa">
                        ...
                        <label for="nombre-empresa" class="label-basico">
                            ...
                            <input type="text" name="nombre-empresa" id="nombre-empresa" class="input-basico">
                        </label>
            ...
            <a href="/plataforma-estudiantes-microempresas/registros/registroEmpresas.php#ancla" class="btn-basico">Continuar</a>
    ...
    <article class="parte2">
        ...
        <div class="containerFormulario2">
            <div class="caja-inputs">
                ...
                <select id="opciones" name="opciones" class="input-select">
                    <option value="opcion1">Presenciales</option>
                    <option value="opcion2">Remotos</option>
                    <option value="opcion3">Ambos (Remotos y prencenciales)</option>
                </select>
            </div>
            <div class="caja-inputs">
        ...
        <a href="/plataforma-estudiantes-microempresas/registros/registroEmpresas.php#ancla2" class="btn-basico">volver</a>
