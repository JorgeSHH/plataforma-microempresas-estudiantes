...
<section class="empresa-estudiante">
    ...
    <div class="container-targetas">
        <div class="targeta">
            ...
            <a href="./registroEmpresas.php"><button type="button" class="btn-basico">Registrarse</button></a>
        </div>
        <div class="targeta-dos">
            <h2 class="titulo-dos">Estudiante</h2>
            <div class="icono">
            ...
            <a href="./registroEstudiantes.php" ><button type="button" class="btn-basico">Registrarse</button></a>
        </div>
    </div>
</section>
</body>
